...
public class DDQService extends AbstractQuotationService implements QuotationService {
	 ...
	 */
	private class DDQuotation implements Quotation {
		String reference;
		ClientInfo info;
		double price;
	...
	/**
	 * Quote generation: 5% discount per penalty point (3 points required for
	 * qualification) 50% penalty for <= 3 penalty points 10% discount per year
	 * no claims
	 * 
	...
	private int getNoClaimsDiscount(ClientInfo info) throws RemoteException {
